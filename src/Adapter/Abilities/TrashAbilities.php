...
final readonly class TrashAbilities {
	...
	public function execute( array $input ): array|WP_Error {
		if ( ! $this->can_trash( $input ) ) {
			return new WP_Error( 'wpcb_forbidden', __( 'You are not permitted to trash this content.', 'wp-content-bridge' ) );
		}
		...
		try {
			...
			return new WP_Error( 'wpcb_forbidden', __( 'Trashing content is not permitted for this type.', 'wp-content-bridge' ) );
			...
			return new WP_Error( 'wpcb_internal_error', __( 'The content could not be moved to trash.', 'wp-content-bridge' ) );
		}
	}
