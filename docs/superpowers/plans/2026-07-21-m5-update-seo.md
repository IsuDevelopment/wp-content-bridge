...
> **2026-07-21 status-boundary amendment:** references below to the future
> `publish-content` Plan 4 are superseded by ADR 0015. The reserved ability is
> now `transition-content-status`; reversible trash is a separate operation.
